    ...
    return (
        <div className="wrapper ">
            ...
            <div className="wrapper pt-3 pb-5 back_color">
                <div className="wrapper-content-inner pt-3">
                    <ul>
                        <li>
                            <p><a
                        ...
                        <li>
                            <p><a href="/files/install_manual_macos.pdf" target="_blank">Упатство за инсталација на компоненти за токен Gemalto и Java на MAC OS Snow Lepard</a></p>
                        </li>
                        <li>
                            <p><a href="/files/install_manual_ubuntu.pdf" target="_blank"> Упатсво за инсталација на компоненти за токен Gemalto и Java за Ubuntu Linux</a></p>
                        </li>
                    </ul>
