                    ...
                    <Accordion>
                        ...
                        <Accordion.Item eventKey="7">
                            ...
                            <Accordion.Body>
                                ...
                                Доколку се уште налогот стои во статус “Се праќа...” проверете го статусот на налог подоцна
                                со тоа што ќе кликнете на менито Плаќања -> Преглед на е-налози
                            </Accordion.Body>
                        </Accordion.Item>

                        <Accordion.Item eventKey="8">
                            <Accordion.Header>Дали треба да се препрати налог кој има статус „Се праќаат...“ ?</Accordion.Header>
                            <Accordion.Body>
                                Не го препраќајте налогот. Проверете го статусот на налогот подоцна на менито Плаќања ->
                                Преглед на е-налози. Исклучиво налогот кој има статус “Одбиен” може да биде пратен повторно.
                        ...
                        <Accordion.Item eventKey="9">
                            ...
                            <Accordion.Body>
                                Налог со статус одбиен не може да биде препратен. За да го испратите повторно потребно е да
                                се креира и испрати нов налог. Најбрз начин да креирате ист налог како одбиениот е да
                                кликнете на линкот “Препрати“. Корегирајте го податокот поради кој налогот е одбиен и
